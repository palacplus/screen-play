...
public class AuthControllerTests
{
    ...
    private readonly AdminConfiguration _adminConfig = new AdminConfiguration { Email = "admin@example.com" };
    private readonly AuthController _controller;

    public AuthControllerTests()
    {
        _controller = new AuthController(_logger, _authService, _adminConfig);
    }
